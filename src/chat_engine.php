...
<?
// Правила чата
include_once(dirname(__FILE__)."/"."chatface/body/engine_up.htp");
?>
<hr/>
<?
include_once(dirname(__FILE__)."/"."chatface/body/engine.htp");
?>
<hr/>
<?
include_once(dirname(__FILE__)."/"."chatface/body/engine_bot.htp");
?>
<!-- /Main block body -->
</td>
